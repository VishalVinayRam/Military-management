...
urlpatterns = [
   ...
   path('sol/',include(familyurls)),
    ...
    path('reset_password/',auth_views.PasswordResetView.as_view(template_name='forms/password/reset_password.html'), name='password_reset'),
   path('password_reset/done/', auth_views.PasswordResetDoneView.as_view(template_name='forms/password/password_reset_done.html'), name='password_reset_done'),
    path('reset/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name="forms/password/password_reset_confirm.html"), name='password_reset_confirm'),
    path('reset/done/', auth_views.PasswordResetCompleteView.as_view(template_name='forms/password/password_reset_complete.html'), name='password_reset_complete'),      
